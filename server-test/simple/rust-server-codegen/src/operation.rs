...
pub(crate) struct HealthcheckOperationInputWrapper(crate::input::HealthcheckInput);
#[axum::async_trait]
...
pub(crate) struct HealthcheckOperationOutputWrapper(crate::output::HealthcheckOutput);
#[axum::async_trait]
...
pub(crate) struct RegisterServiceOperationInputWrapper(crate::input::RegisterServiceInput);
#[axum::async_trait]
...
pub(crate) enum RegisterServiceOperationOutputWrapper {
